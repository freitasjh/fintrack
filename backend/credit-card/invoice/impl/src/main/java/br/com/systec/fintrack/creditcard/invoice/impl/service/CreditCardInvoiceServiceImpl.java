...
public class CreditCardInvoiceServiceImpl implements CreditCardInvoiceService {
    ...
    public CreditCardInvoice findByDateIfNotExistCreate(CreditCard creditCard) throws BaseException {
        CreditCardInvoice creditCardInvoice = repository.findByDateClose(LocalDate.now(), creditCard.getId())
                .orElse(null);
    ...
    public List<CreditCardInvoiceResultVO> findByFilter(CreditCardInvoiceFilterVO filterVO) throws BaseException {
