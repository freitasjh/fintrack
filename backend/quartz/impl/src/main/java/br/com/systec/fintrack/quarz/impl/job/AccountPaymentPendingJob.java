...
@Component
public class AccountPaymentPendingJob implements Job {
    private static final Logger log = LoggerFactory.getLogger(AccountPaymentPendingJob.class);
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        try {
            log.info("@@@ AccountPaymentPendingJob.execute({})", context.getJobDetail().getDescription());
