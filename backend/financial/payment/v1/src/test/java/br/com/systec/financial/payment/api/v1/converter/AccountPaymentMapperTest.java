package br.com.systec.financial.payment.api.v1.converter;
...
public class AccountPaymentMapperTest {
    ...
    void whenConvertAccountPaymentInputDTOToAccountPayment() {
        ...
        Assertions.assertThat(accountPaymentConverted.getDateProcessed()).isAfterOrEqualTo(accountPayment.getDateProcessed());
        Assertions.assertThat(accountPaymentConverted.getDateRegister()).isAfterOrEqualTo(accountPayment.getDateRegister());
