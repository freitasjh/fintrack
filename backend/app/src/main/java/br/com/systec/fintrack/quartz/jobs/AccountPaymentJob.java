...
import br.com.systec.fintrack.financial.accountPayment.jms.AccountPaymentJmsMapper;
import br.com.systec.fintrack.financial.accountPayment.jms.AccountPaymentJmsType;
import br.com.systec.fintrack.financial.accountPayment.jms.AccountPaymentJmsVO;
...
public class AccountPaymentJob implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        try {
            ...
            template.convertAndSend(RabbitMQConstants.ACCOUNT_PAYMENT, AccountPaymentJmsMapper.toJson(jmsVO));
        } catch (Exception e) {
