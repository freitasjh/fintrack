package br.com.systec.fintrack.administrator.category.jms;

import br.com.systec.fintrack.administrator.category.model.Category;
import br.com.systec.fintrack.administrator.category.service.CategoryService;
...
public class CategoryNewAccountJMS {
    ...
    @RabbitListener(queues = RabbitMQConstants.NEW_ACCOUNT_CATEGORY_QUEUE)
