package br.com.systec.fintrack.financial.creditCard.transaction.api.v1.controller;
...
public class CreditCardTransactionControllerTest {
    private static final Logger log = LoggerFactory.getLogger(CreditCardTransactionControllerTest.class);
